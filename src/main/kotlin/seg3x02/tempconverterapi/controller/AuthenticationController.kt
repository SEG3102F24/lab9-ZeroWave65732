...
import seg3x02.tempconverterapi.controller.payload.MessageReponse
    ...
    fun registerUser(@RequestBody signUpRequest: @Valid SignUpData): ResponseEntity<*> {
        if (userRepository.existsByUsername(signUpRequest.username)){
            return ResponseEntity
                .badRequest()
                .body<Any>(MessageReponse("Error: Username is already taken!"))
        }
        ...
        return ResponseEntity.ok<Any>(MessageReponse("User Registered Successfully"))
    }
}